...
Object.prototype.beget = function () { //sets up a prototype function;
  function F() {}
  F.prototype = this;
  return new F();
}

function Gonzo(age, hobby, trick) { //passes 3 parameters
  Muppet.call(this, age, hobby); //similar function (this<- refers to original function , age, hobby)
  this.trick = trick;
